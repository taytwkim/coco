...
(* 
 test if interp works as expected
  - str:  test name
  - i:    list of RISC-V instructions
  - e1:   expected registers (what the registers should look like)
  - e2:   expected memory (what the memory should look like)
  - e3:   expected PC (where the PC should be at)
 *)
